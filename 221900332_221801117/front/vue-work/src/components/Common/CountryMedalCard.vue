<template>
  <el-card class="box-card MedalCard">
      <div class="countryName" v-text="countryName"></div>
      <div class="medalRank" v-text="getRank"></div>
      <div class="medal-content">
        <span class="medal-title">金牌:</span>
        <span class="medal-num" v-text="gold"></span>
      ...
      <div class="medal-content">
        ...
        <span class="medal-num" v-text="silver"></span>
      ...
      <div class="medal-content">
        ...
        <span class="medal-num" v-text="copper"></span>
...
<script>
export default {
  name: "CountryMedalCard",
  data(){
    return{
      rankArray:['一','二','三','四','五','六','七','八','九','十']
    }
  },
  props:{
      countryName:{
  ...
  computed:{
    getRank:function (){
      if(this.rank<11){
        return "金牌第"+this.rankArray[this.rank - 1]+"名";
      }
      return "金牌第"+this.rank+"名";
    }
  },
  watch:{
